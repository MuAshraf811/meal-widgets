...
import 'package:custom_widgets/new-gradiant/new_gradiant.dart';
...
import 'package:custom_widgets/search-for-reciepe/search_view.dart';
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                CustomParcentIndicator(
                                  radius:
                                      MediaQuery.sizeOf(context).height / 15.7,
                                  parcent: 0.9,
                                  leftPadding: 17,
                          ...
                          SizedBox(
                              height: MediaQuery.sizeOf(context).height / 21.5),
                          SectionTitleAndItsActionButton(
                            ...
                            onTap: () {
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                    builder: (context) => const NewGradiant()),
                              );
                            },
                          ),
                          SizedBox(
                          ...
                          const CustomDividerBetweenIngradients(),
                          SizedBox(
                              height: MediaQuery.sizeOf(context).height / 45.5),
                          ...
                          const CustomDividerBetweenIngradients(),
                          SizedBox(
                              height: MediaQuery.sizeOf(context).height / 27.5),
                          SectionTitleAndItsActionButton(
                          ...
                          const Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                MakingMealStep(
                                  stepName:
                                      'تقليب العجين جيدا وتركه لمدة 10 دقائق',
                                ),
                              ],
                            ),
                          ),
